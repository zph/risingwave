...
use risingwave_connector::source::{
    ...
    KINESIS_CONNECTOR, LEGACY_S3_CONNECTOR, MONGO_OPLOG_CONNECTOR, MQTT_CONNECTOR, NATS_CONNECTOR,
    NEXMARK_CONNECTOR, OPENDAL_S3_CONNECTOR, POSIX_FS_CONNECTOR, PULSAR_CONNECTOR,
};
